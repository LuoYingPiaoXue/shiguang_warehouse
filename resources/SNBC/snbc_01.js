// 陕西工商职业学院(snbc.edu.cn) 拾光课程表适配脚本
// 基于怀化学院(hhtc.edu.cn) 的适配脚本修改而来,感谢原作者的贡献
// 出现问题请提联系开发者或者提交Pull Request更改
...
async function saveAppTimeSlots() {
    const timeSlots = [
        ...
        { "number": 6, "startTime": "14:20", "endTime": "15:10" },
        { "number": 7, "startTime": "15:20", "endTime": "16:10" },
        { "number": 8, "startTime": "16:10", "endTime": "17:00" },
        { "number": 9, "startTime": "17:40", "endTime": "18:30" },
        { "number": 10, "startTime": "18:30", "endTime": "19:20" },
		{ "number": 11, "startTime": "19:30", "endTime": "20:20" },
		{ "number": 12, "startTime": "20:20", "endTime": "21:10" }
    ];
...
async function runImportFlow() {
    try {
        ...
        const response = await fetch("https://jwgl.snouedu.cn/jsxsd/xskb/xskb_list.do", {
            method: "POST",
